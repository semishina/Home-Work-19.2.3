...
class TestCalc:
    ...
    # def test_multiply_calculate_negative(self):
    #     assert self.calc.multiply(self, 2, 2) == 5

    def test_division_calculate_positive(self):
        assert self.calc.division(self, 9, 3) == 3

    # def test_division_calculate_negative(self):
    #     assert self.calc.division(self, 9, 3) == 0

    # def test_division_calculate_negative_2(self):
    #     assert self.calc.division(self, 9, 0) == 0
    ...
    # def test_subtraction_calculate_negative(self):
    #     assert self.calc.subtraction(self, 10, 3) == 5
    ...
    # def test_adding_calculate_negative(self):
    #     assert self.calc.adding(self, 3, 3) == 4
